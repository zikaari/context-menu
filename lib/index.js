...
class ContextMenu extends React.Component {
    constructor(props) {
        super(props);
        this.cancelElementVirtualClick = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.virtualizeElementClick = (e) => __awaiter(this, void 0, void 0, function* () {
    ...
    render() {
        ...
        return (React.createElement("div", { ref: (r) => this.clickMask = r, onMouseDown: this.handleMaskMouseDown.bind(this), onMouseUp: this.handleMaskMouseUp.bind(this), style: { height: '100vh', width: '100vw', position: 'absolute', left: '0', top: '0' } }, menu));
    }
    componentDidMount() {
        singleton = this;
    ...
    renderMenu(data, submenu = false) {
        ...
        return (React.createElement("div", { className: `context-menu ${submenu ? 'submenu' : ''} ${this.props.theme || 'light'}`, style: { position: 'absolute', display: 'none' } }, menu));
    }
    handleMaskMouseUp(ev) {
        const el = document.elementFromPoint(ev.pageX, ev.pageY);
    }
    handleMaskMouseDown(ev) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    adjustContextMenuClippingAndShow() {
        const rootMenu = this.clickMask.firstElementChild;
    ...
    hideContextMenu() {
        this.visible = false;
        this.hideSubMenus(this.clickMask.querySelector('context-menu'));
        this.clickMask.style.display = 'none';
    }
    hideSubMenus(level) {
        if (!level) {
